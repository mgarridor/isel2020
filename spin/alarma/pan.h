...
#define PanSource	"modelAlarma.pml"
...
#define _nstates4	14	/* espec3 */
#define minseq4	100
#define maxseq4	112
#define _endstate4	13

#define _nstates3	14	/* espec2 */
#define minseq3	87
#define maxseq3	99
#define _endstate3	13

#define _nstates2	14	/* espec1 */
#define minseq2	74
#define maxseq2	86
...
#define PfsmAlarma	((P0 *)this)
typedef struct P0 { /* fsmAlarma */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
