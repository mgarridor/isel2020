...
#define _nstates4	14	/* especLed3 */
#define minseq4	69
#define maxseq4	81
#define _endstate4	13

#define _nstates3	14	/* especLed2 */
#define minseq3	56
#define maxseq3	68
#define _endstate3	13

#define _nstates2	14	/* especLed1 */
#define minseq2	43
#define maxseq2	55
#define _endstate2	13

#define _nstates1	15	/* entorno */
#define minseq1	29
#define maxseq1	42
#define _endstate1	14

#define _nstates0	30	/* fsmLed */
#define minseq0	0
#define maxseq0	28
...
#define PfsmLed	((P0 *)this)
typedef struct P0 { /* fsmLed */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
